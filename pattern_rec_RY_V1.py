...
SPY_Historic_Max = SPY_Historic_Max.astype(datetime)
...
def patternRecognition():
    ...
    predArray = []
    if patFound == 1:
        fig = plt.figure(figsize=(15,10)).suptitle('Pattern REc >40% Short Term Lookback')
      ...
      #  print (predArray)
        ...
        plt.plot(xp, patForRec, '#54fff7', linewidth = 4)
        #plt.grid(True)
